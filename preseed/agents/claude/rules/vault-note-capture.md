...
**Why:** in-chat acknowledgement evaporates at turn-end. A vault note persists across sessions, is queryable from any future session via `mcp__graphify__*`, and shows up in SilverBullet immediately. See the skill for the full workflow, edge cases, and what NOT to write to.
