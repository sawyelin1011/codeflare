...
> _First-load tip: Codeflare prepares an encrypted Vault cache in each browser you use. The first open on a new device can take a few minutes; later opens are fast as long as that browser keeps its storage._

# Notes and references

- [[Notes]] — durable notes saved when you ask the agent to take a note.
- [[References]] — source material, docs, and links you want to keep close.
...
${(function()
  ...
  if not ok then return "_Preparing your notes and references, reload in a few seconds..._" end
  return r or "_No notes or references yet._"
end)()}
