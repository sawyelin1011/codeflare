...
<!-- @impl: landing/src/scripts/hero-kicker.ts -->
<!-- @impl: landing/src/scripts/orch.ts -->
<!-- @impl: landing/src/components/HeroKicker.astro -->
<!-- @impl: landing/src/lib/hero-kicker.ts -->
...
<!-- @test: landing/src/__tests__/hero-kicker.test.ts (REQ-LANDING-001 describe -> capability word rotation model keeps active word on the baseline, wraps the previous word to the top of the stack, fades queued words by stack position, and builds one accessible sentence from the static parts + rotating word set) -->
